...
![](https://github.com/knsroo/websm/blob/master/dia (1).png?raw=true)
...
![](https://github.com/knsroo/websm/blob/master/dia (2).png?raw=true)
...
```
Структура:
![](https://github.com/knsroo/websm/blob/master/dia (3).png?raw=true)
Список правил:
Правило | Обработчик
---- | ----
...
```
Структура:
![](https://github.com/knsroo/websm/blob/master/dia (4).png?raw=true)
Список правил:
...
```
Структура:
![](https://github.com/knsroo/websm/blob/master/dia (5).png?raw=true)
Список правил:
Правило | Метод | Обработчик
---- |----| ----
www.domain.com | GET | getIndex()
...
Список правил:
![](https://github.com/knsroo/websm/blob/master/dia (6).png?raw=true)
Правило | Метод | Обработчик
---- |----| ----
www.domain.com | GET | getIndex()
